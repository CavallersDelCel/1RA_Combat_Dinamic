...
pvpfw_cleanUp_abandonRadius = 2000; // If no unit is closer than the specified distance, the removal countdown will start
pvpfw_cleanup_abandondTimer = 1300; // The vehicle will be removed after the specified time
...
//////////////////////////////
pvpfw_cleanUp_vehicleRadius = 1000; // Destroyed vehicles cleanup timer will start if no unit is closer than this
pvpfw_cleanUp_vehicleTimer = 30;

//////////////////
// Clean bodies //
//////////////////
pvpfw_cleanUp_bodyTimer = 3600; // Bodies will be removed after the specified amount of seconds
