...
CUP_checkLift =
{
  ...
  if ((vehicle player isKindOf "Helicopter") && (count (nearestObjects [vehicle player, ["Car", "Tank", "Ship", "Plane"], 20]) > 0) && (_speed < 10) && (driver vehicle player == player)) then {_return = true};
