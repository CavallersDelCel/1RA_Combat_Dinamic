...
tcb_ais_revive_guaranty			=	true;
tcb_ais_realistic_mode			=	false;


tcb_ais_medical_education		=	0;

//	Who can revive a concious unit?	0 == everybody		1 == everybody with a medikit		2 == only medics 	(affect both, AI and players!)
