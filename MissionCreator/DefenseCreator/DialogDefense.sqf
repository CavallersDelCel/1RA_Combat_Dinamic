...
_handle = createDialog "AOW_dialog2";
waitUntil {dialog};

// Iniatiate array first time the mission is played
_oldvalues = profileNamespace getVariable "AOW_DefaultDefenseValue";
if (isNil "_oldvalues") then {
	_default = [3,3,0,2,5,2,3,1,6,1,0];
	// [X,Y,waves,delays,AIP,AIPs,AIM,AIA,AIS,AIH,Faction]
	profileNamespace setVariable ["AOW_DefaultDefenseValue",_default];
};
...
_oldwaves = _oldvalues select 2; // Delay between waves
_olddelay = _oldvalues select 3; // Number of waves
...
// Wave number
_index_zone_waves_0 = lbAdd [4701, "1"];
_index_zone_waves_1 = lbAdd [4701, "2"];
_index_zone_waves_2 = lbAdd [4701, "3"];
_index_zone_waves_3 = lbAdd [4701, "4"];
_index_zone_waves_4 = lbAdd [4701, "5"];
_index_zone_waves_5 = lbAdd [4701, "6"];
_index_zone_waves_6 = lbAdd [4701, "7"];
_index_zone_waves_7 = lbAdd [4701, "8"];
_index_zone_waves_8 = lbAdd [4701, "9"];
_index_zone_waves_9 = lbAdd [4701, "10"];
lbSetCurSel [4701, _oldwaves];

// Delay between waves
_index_zone_delay_0 = lbAdd [4702, "20 sec"];
_index_zone_delay_1 = lbAdd [4702, "40 sec"];
_index_zone_delay_2 = lbAdd [4702, "60 sec"];
_index_zone_delay_3 = lbAdd [4702, "80 sec"];
_index_zone_delay_4 = lbAdd [4702, "100 sec"];
_index_zone_delay_5 = lbAdd [4702, "120 sec"];
_index_zone_delay_6 = lbAdd [4702, "3 min"];
_index_zone_delay_7 = lbAdd [4702, "4 min"];
_index_zone_delay_8 = lbAdd [4702, "5 min"];
lbSetCurSel [4702, _olddelay];
...
// AI Static
_index_zone_static_D= lbAdd [4707, localize "STR_AOW_UnusedDef"];
lbSetCurSel [4707, _index_zone_static_D];
...
_index_zone_faction_3 = lbAdd [4709, "DO NOT USE"];
_index_zone_faction_4 = lbAdd [4709, "FIA"];
_index_zone_faction_5 = lbAdd [4709, "FIA"];
_index_zone_faction_6 = lbAdd [4709, "DO NOT USE"];
...
_index_zone_faction_16 = lbAdd [4709, "LEIGHTS : UKRAINIAN"];
...
_index_zone_faction_23 = lbAdd [4709, "LEIGHTS : ULTRANATIONALISTS"];
_index_zone_faction_24 = lbAdd [4709, "LEIGHTS : IRAQI TERRORISTS"];
_index_zone_faction_25 = lbAdd [4709, "LEIGHTS : RACS"];
_index_zone_faction_26 = lbAdd [4709, "LEIGHTS : AFGHAN MILITIA"];
...
lbSetColor [4709,26,[0,1,0,1]];

// Disable escape key
_noesc = (findDisplay 9962) displayAddEventHandler ["KeyDown", "if ((_this select 1) == 1) then { true }"];
waitUntil {!dialog};
(findDisplay 9962) displayRemoveEventHandler ["KeyDown", _noesc];