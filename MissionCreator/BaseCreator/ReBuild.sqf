...
// Flag Pole
[[baseFlagPole, [localize "str_AOW_Menu1","null = CreateDialog 'AOW_Menu_Dialog'",[],6,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
[[baseFlagPole, [localize "str_AOW_Menu2","MissionCreator\ZoneCreator\Zone1.sqf",[],5.9,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
[[baseFlagPole, [localize "str_AOW_Menu3","MissionCreator\TasksCreator\Tasks1.sqf",[],5.8,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
[[baseFlagPole, [localize "str_AOW_Menu4","MissionCreator\BaseCreator\Base1.sqf",[],5.7,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
...
[[NBPlane, [localize "str_AOW_Menu_SpawnP_4",{[["planes"], [], "VVS5"] execVM "ASORVS\open.sqf"},[],5.7,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
