...
fn_AOW_spawnExtractionMission = {
    ...
    [[AOW_TE1, ["Follow me","[AOW_TE1] join group (_this select 1);",[],6,false,true,"",""]],"MHQ_fnc_addAction",true,true] spawn BIS_fnc_MP;
...
fn_AOW_spawnAssaultMission = {
    ...
    _fobtemplate = [getMarkerPos "AOW_Assault1", random 360, call (compile (preprocessFileLineNumbers format ["MissionCreator\TasksCompositions\%1.sqf", _fobpool]))] call BIS_fnc_ObjectsMapper;
